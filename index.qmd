...
Supposons que l'on veuille peindre un mur en vert, et que la procédure `mélanger_couleurs_sur_palette(palette)` mélange les deux premières couleurs de la palette et stocke le résulat au troisième emplacement, on pourrait faire :
