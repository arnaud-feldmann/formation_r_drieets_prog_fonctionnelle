...
Celles-ci posent un problème vis-à-vis de l'évaluation de leurs *symboles* internes. Que se passe-t-il par exemple quand j'exécute ce code R ? On y appelle une fonction qui renvoie elle-même une fonction. Il y a plein de choses qui s'appellent `x` ! Comment cela peut bien se résoudre ?
