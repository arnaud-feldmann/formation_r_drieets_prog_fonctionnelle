...
Le code n'est interprêté qu'à son temps d'exécution. Contrairement à des langages plus formels qui donnent une importance plus grande au temps de "définition", notamment les langages compilés, R attend le dernier moment pour vérifier si quelque chose a un sens.
