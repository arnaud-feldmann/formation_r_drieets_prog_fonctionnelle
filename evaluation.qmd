...
Cela à l'avantage d'être plus succint ; cela a le désavantage d'être moins explicite. C'est au choix.
...
* retourne des calculs de summarise renseignés dans les `...`.
